...
@interface ScriptHandler : NSObject <WKScriptMessageHandler, WKURLSchemeHandler, WKNavigationDelegate>
{
  IWebView* mWebView;
}
@end
...
//  components.path = [[NSString alloc] initWithUTF8String: "index.html"];
